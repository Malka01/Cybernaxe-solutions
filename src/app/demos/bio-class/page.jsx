...
const translations = {
  en: {
    ...
    heroSub:
      'Theory, revision, and paper classes taught by an active researcher in Biotechnology and Bio Engineering - with a BSc (Hons) from Uva Wellassa University.',
    ...
    aboutP1b: 'Bio Engineering, Biotechnology, Agricultural Sciences, and Polymer Technology.',
    aboutP2a: 'I hold a ',
    aboutP2b: 'BSc (Hons) from Uva Wellassa University',
    aboutP2c:
      ' and continue to pursue advanced research in Bio Engineering - alongside my work in academic teaching, laboratory research, and scientific communication.',
    aboutP3:
    ...
    credResearcherSub: 'Bio Engineering',
  ...
  en: [
    {
      ...
      desc: 'Graduated with a BSc (Hons) in Industrial Information Technology - specializing in Bio Engineering and Biotechnology.',
      icon: '🎓',
    },
    {
      year: '2017',
    ...
    },
    {
      ...
      desc: 'Published research findings in Bio Engineering - bringing active scientific work directly into the classroom.',
      icon: '🔬',
    },
    {
      year: '2025',
